...
#define CSAFE_NOTNULL_H
    ...
    /* includes */
#include "csafe_assert.h" /* assert_not_null() */

    /* defines */
/**
 * @brief assert that X arguments are not null
 */
#define _not_null_1(argument)         assert_not_null(argument)
 ...
 */
#define not_null(...) _not_null_get_macro(__VA_ARGS__, _not_null_6, _not_null_5, _not_null_4, _not_null_3, _not_null_2, _not_null_1)(__VA_ARGS__)
