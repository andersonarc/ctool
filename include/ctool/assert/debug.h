 ...
 *
 *      Macro postfixes:
 *  assertd_'c' - with custom message
 */
    /* header guard */
 ...
 */
#define assertd_status(variable) assertd_equals(variable, ST_OK)
#define assertdc_status(variable, message, ...) assertdc_equals(variable, ST_OK, message, ##__VA_ARGS__)
 ...
 */
#define assertd_notnull(variable) _ctool_assert_d_impl(_ctool_assert_notnull(variable), (variable) != NULL)
#define assertdc_notnull(variable, message, ...) _ctool_assert_d_impl(message, (variable) != NULL, ##__VA_ARGS__)
